...
void ABossAIController::Tick(float DeltaTime)
{
    ...
    if (BossCharacter)
    {
        ...
        if (BBComp)
        {
            ...
            float maxWeight = FMath::Max(finalWeight1, FMath::Max(finalWeight2, FMath::Max(finalWeight3, finalWeight4)));
            if (maxWeight == finalWeight4)
                NextAttack = 4;
            else if (maxWeight == finalWeight3)
                NextAttack = 3;
            else if (maxWeight == finalWeight2)
                NextAttack = 2;
            else if (maxWeight == finalWeight1)
                NextAttack = 1;
            else
                NextAttack = 0;
